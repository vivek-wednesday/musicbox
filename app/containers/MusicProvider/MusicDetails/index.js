...
export function MusicDetails({ musicResult, intl, dispatchGetMusicDetail, detailError }) {
  ...
  return detailError === null ? (
    <StyleDiv>
      ...
      >
        <Statistic title="Artist" value={intl.formatMessage({ id: 'artist' }, { name: musicResult.artistName })} />
        <br />
        <Statistic title="Album" value={intl.formatMessage({ id: 'album' }, { album: musicResult.collectionName })} />
        <br />
        <Popover
          content={
            <>
              <Price data-testid="price">
                {intl.formatMessage({ id: 'price' }, { price: musicResult.trackPrice })}
              </Price>
              <Para data-testid="genre">
                {intl.formatMessage({ id: 'genre' }, { genre: musicResult.primaryGenreName })}
              </Para>
