...
describe('<StyledGrid />', () => {
  ...
  it('should render and match the snapshot', () => {
    const { baseElement } = renderWithIntl(<StyledGrid musicData={sampleData} />);
    expect(baseElement).toMatchSnapshot();
  });

  it('should render cards with music data', () => {
    const { getAllByTestId } = renderWithIntl(<StyledGrid musicData={sampleData} />);
  ...
  it('should render disabled button on play', async () => {
    ...
    const {getAllByTestId, getByTestId} = renderWithIntl(<StyledGrid musicData={sampleData} />);
    await timeout(1000)
  ...
  it('should render pause button on play', async () => {
    ...
    const {getByTestId} = renderWithIntl(<StyledGrid musicData={sampleData} />);
    await timeout(1000)
